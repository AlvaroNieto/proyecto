...
-- Tiempo de generación: 06-03-2017 a las 05:21:07
...
--
ALTER TABLE `item`
  MODIFY `reference` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `messages`
  MODIFY `mid` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
